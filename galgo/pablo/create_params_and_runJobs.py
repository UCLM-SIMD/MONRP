...
# 'e1', 'e2', 'e3','e4','e5','e6']
dependencies = ['D']  # {'D', 'd'}
dataset = ['d3']  # 'p1', 'p2', 's1','s2','s3', 's4'

# COMMON HYPER-PARAMETERS #
# possible algorithm values: {'GRASP', 'feda', 'geneticnds', 'pbil', 'umda', nsgaii}
algorithm = 'umda'  # 'GRASP', 'geneticnds', 'nsgaii', 'umda', 'pbil', 'feda', 'mimic', 'random'
seed = 5
...
population_size = [1000]  # [100, 200, 500, 700, 1000 #[, 2000, 3000]
num_generations = [50]  # [50, 100, 200, 300, 400]
