...
with open('merged_output_grasp.txt', 'w') as outfile:
	outfile.write("Dataset,Algorithm,Iterations,Solutions per Iteration,Local Search Type,Time(s),AvgValue,BestAvgValue,HV,Spread,NumSolutions,Spacing,NumGenerations\n")
