...
class EDAAlgorithm(AbstractAlgorithm):  # Estimation of Distribution Algorithm
    ...
    @abstractmethod
    def learn_probability_model(self) -> List[float]:
        pass
    ...
    '''
    @abstractmethod
    def sample_new_population(self) -> List[Solution]:
        pass
