...
class GeneticAlgorithm(Algorithm):
    def __init__(self, problem, random_seed=None, population_length=20, max_generations=1000,
        ...
        self.utils = GeneticUtils(
            self.problem, self.random_seed, selection_candidates, crossover_prob, mutation_prob)
        self.executer = GeneticExecuter()
    ...
    def run(self):
        ...
        while num_generations < self.max_generations:
            ...
            self.calculate_last_generation_with_enhance(
                num_generations, returned_population)
